...
@RequestMapping("/producto") //Este maneja los mapeos empezando en Producto
public class ProductoController {
    ...
    public String guardar(Producto producto,
        ...
        if (!imagenFile.isEmpty()) {
            ...
            //Construir el objeto ruta
            String rutaImagen
                    = firebaseStorageService.cargaImagen(imagenFile,
                            "producto",
                            producto.getIdProducto());

            //Poner el objeto imagen en la producto 
            //para salir del if y guardarlo
    ...
    public String eliminar(Producto producto,
        ...
        //Antes de eliminar verificar que exista el registro
    ...
    //Tomar el elemento producto y el Modelo del elemento 
