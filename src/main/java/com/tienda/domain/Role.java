...
@Table(name = "rol") //Definir el nombre de la tabla
public class Role implements Serializable { //Se deben poder serializar
    ...
    private long idRol; //El ID va a ir sin valor, la base de datos
